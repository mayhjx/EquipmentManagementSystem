        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDemo = table.Column<bool>(nullable: true),
                    ...
                    IsInventoryComplete = table.Column<bool>(nullable: true),
                    ...
                    IsFactoryAcceptance = table.Column<bool>(nullable: true),
                    ...
                    IsTrainingUseAndMaintenance = table.Column<bool>(nullable: true),
                    TrainingSignInFormFileName = table.Column<string>(nullable: true),
                    TrainingSignInFormFilePath = table.Column<string>(nullable: true),
                    IsSelfBuilt = table.Column<bool>(nullable: true),
                    IsEngineerAssistance = table.Column<bool>(nullable: true),
                    MethodConstructionRemark = table.Column<string>(nullable: true),
                    IsAcceptance = table.Column<bool>(nullable: true),
