...
{
    public class MaintenanceRecordOfYuanSuAuthorizationHandler :
        AuthorizationHandler<OperationAuthorizationRequirement, MaintenanceRecordOfYuanSu>
    {
        // 元素项目维护记录权限控制，如果修改的话，记得同时更新液质维护记录的权限控制
        public MaintenanceRecordOfYuanSuAuthorizationHandler()
        {
        }

        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context,
                                                        OperationAuthorizationRequirement requirement,
                                                        MaintenanceRecordOfYuanSu resource)
        {
